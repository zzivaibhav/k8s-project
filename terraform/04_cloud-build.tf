...
resource "google_secret_manager_secret_version" "github_token_secret_version" {
    ...
    secret_data_wo  = var.github_token_secret
...
resource "google_cloudbuildv2_connection" "my_connection" {
    ...
    depends_on = [google_secret_manager_secret_iam_policy.policy, google_project_service.cloud_build_api]
}
